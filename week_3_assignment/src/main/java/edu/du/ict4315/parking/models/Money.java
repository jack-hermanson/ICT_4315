...
public class Money {
    ...
    public static Money multiply(Money toMultiply, double multiplyBy) {
        double resultBeforeRounding = toMultiply.cents * multiplyBy;
        long roundedResult = Math.round(resultBeforeRounding);
        return new Money(roundedResult);
    }
