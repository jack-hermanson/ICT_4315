...
public class MoneyTest {
    ...
    @Test
    void testMultiplyEvenNumber() {
        Money money = Money.multiply(new Money(50, 0), 0.5);
        assertEquals(money.getCents(), 2500);
    }


    @Test
    void testMultiplyWithRounding() {
        Money money = Money.multiply(new Money(100), 0.875);
        assertEquals(money.getCents(), 88);
    }
